...
function Footer() {
  return (
    <section className='relative overflow-hidden bg-gray-400 border border-t-2 border--t-black'>
            ...
            <div className='-m-6 flex flex-wrap'>
                <div className='w-full p-6 md:w-1/2 lg:w-5/12'>
                    <div className='flex h-full flex-col justify-between'>
                        ...
                        <div>
                            <p className='text-sm text-gray-600'>&copy;Copyright 2025. All Rights Reserved by Harshikant Dubey.</p>
                        </div>
                    </div>
                </div>
